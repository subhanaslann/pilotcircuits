 ...
 *
 * Node 23.6+ runs the TypeScript module above without a build step, so the
 ...
 * `omitBackground` is what makes the PNGs transparent rather than white. It is
 * not a dependency of the product: point `PLAYWRIGHT_MODULE` at an install, or
 * have one resolvable from here.
 *
