...
/** Arduino Uno R3 — 72.58 x 53.34 in millimetres. Origin is the top-left of the PCB, 4mm left of it (the USB shell overhangs). */
export function UnoArtwork({ led13, ledPower, ledTX, ledRX }: { led13?: boolean; ledPower?: boolean; ledTX?: boolean; ledRX?: boolean }) {
  return (
    <g fontFamily="monospace" fontSize={2}>
      <defs>
        <g id="uno-led-body" fill="#eee">
          <rect x="0" y="0" height="1.2" width="2.6" fill="#c6c6c6" />
          <rect x="0.6" y="-0.1" width="1.35" height="1.4" stroke="#aaa" strokeWidth="0.05" />
        </g>
      </defs>
      <filter id="uno-ledFilter" x="-0.8" y="-0.8" height="2.2" width="2.8">
        <feGaussianBlur stdDeviation="0.5" />
      </filter>
      <pattern id="uno-pins-female" width="2.54" height="2.54" patternUnits="userSpaceOnUse">
        <rect x="0" y="0" width="2.54" height="2.54" fill="#333" />
        <rect x="1.079" y="0.896" width="0.762" height="0.762" style={{ fill: '#191919' }} />
        <path
      ...
      <pattern id="uno-pin-male" width="2.54" height="4.80" patternUnits="userSpaceOnUse">
      ...
      <pattern id="uno-mcu-leads" width="2.54" height="0.508" patternUnits="userSpaceOnUse">
        <path
      ...
      <g transform="translate(17.497 1.27)">
        <rect width={0.38 + 2.54 * 10} height="2.54" fill="url(#uno-pins-female)" />
      </g>
      <g transform="translate(44.421 1.27)">
        <rect width={0.38 + 2.54 * 8} height="2.54" fill="url(#uno-pins-female)" />
      </g>
      <g transform="translate(26.641 49.53)">
        <rect width={0.38 + 2.54 * 8} height="2.54" fill="url(#uno-pins-female)" />
      </g>
      <g transform="translate(49.501 49.53)">
        <rect width={0.38 + 2.54 * 6} height="2.54" fill="url(#uno-pins-female)" />
      </g>
      <g>
        <path
      ...
      <g transform="translate(14.1 4.4)">
        <rect width="7" height="4.80" fill="url(#uno-pin-male)" />
      </g>
      <g transform="translate(63 27.2) rotate(270 0 0)">
        <rect width="7" height="4.80" fill="url(#uno-pin-male)" />
      </g>
      <g transform="translate(57.3, 16.21)">
        <use xlinkHref="#uno-led-body" />
        {ledPower ? (
          <circle cx="1.3" cy="0.55" r="1.3" fill="#80ff80" filter="url(#uno-ledFilter)" />
        ) : null}
      </g>
      <text fill="#fff">
      ...
      <g transform="translate(26.87,11.69)">
        <use xlinkHref="#uno-led-body" />
        {led13 ? (
          <circle cx="1.3" cy="0.55" r="1.3" fill="#ff8080" filter="url(#uno-ledFilter)" />
        ) : null}
      </g>
      <g transform="translate(26.9, 16.2)">
        <use xlinkHref="#uno-led-body" />
        {ledTX ? (
          <circle cx="0.975" cy="0.55" r="1.3" fill="yellow" filter="url(#uno-ledFilter)" />
        ) : null}
      </g>
      ...
      <text
        x="31"
        y="20.2"
        style={{ fontSize: '2.8px', fontWeight: 'bold', lineHeight: '1.25', fill: '#fff' }}
      >
        ARDUINO
      </text>
      <rect
