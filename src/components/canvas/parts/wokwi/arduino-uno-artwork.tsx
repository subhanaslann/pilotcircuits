  ...
  return (
    <g fontFamily="monospace" fontSize={2}>
      ...
      <g transform="translate(17.497 1.27)">
        <rect width={0.38 + 2.54 * 10} height="2.54" fill={`url(#${uid}-uno-pins-female)`} />
      </g>
      <g transform="translate(44.421 1.27)">
        <rect width={0.38 + 2.54 * 8} height="2.54" fill={`url(#${uid}-uno-pins-female)`} />
      </g>
      <g transform="translate(26.641 49.53)">
        <rect width={0.38 + 2.54 * 8} height="2.54" fill={`url(#${uid}-uno-pins-female)`} />
      </g>
      <g transform="translate(49.501 49.53)">
        <rect width={0.38 + 2.54 * 6} height="2.54" fill={`url(#${uid}-uno-pins-female)`} />
      </g>
      <g>
        <path
      ...
      <g transform="translate(14.1 4.4)">
        <rect width="7" height="4.80" fill={`url(#${uid}-uno-pin-male)`} />
      </g>
      <g transform="translate(63 27.2) rotate(270 0 0)">
        <rect width="7" height="4.80" fill={`url(#${uid}-uno-pin-male)`} />
      </g>
      <g transform="translate(57.3, 16.21)">
        <use xlinkHref={`#${uid}-uno-led-body`} />
        {ledPower ? (
          <circle
            cx="1.3"
            cy="0.55"
