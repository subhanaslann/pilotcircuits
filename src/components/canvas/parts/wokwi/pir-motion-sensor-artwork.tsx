...
/** PIR motion sensor (HC-SR501) — 90.7 x 92.4 in CSS pixels. Origin is the top-left of the module board; the three pins hang below it. */
export function PirMotionSensorArtwork() {
  return (
    <g>
      <g fill="#c6bf95">
        <path
      ...
      <g transform="translate(-5.81 -5.45)" clipPath="url(#pir-a)" fill="#fbfcfb">
        <path
        ...
        />
        <g fill="none" stroke="#d2d8d8" strokeWidth=".4px">
      ...
      <text fill="#ffffff" fontFamily="sans-serif">
        <tspan x="33.293" y="73.864" fontSize="9.88px">
          +
        </tspan>
        <tspan x="43.531" y="72.609" fontSize="6.38px">
          D
        </tspan>
      </text>
