...
/** HC-SR04 ultrasonic sensor — 45 x 25 in millimetres. Origin is the top-left of the module board. */
export function Hcsr04Artwork() {
  return (
    <g fontFamily="monospace">
      <defs>
        <pattern patternUnits="userSpaceOnUse" width="2" height="2" id="sr04-checkerboard">
        ...
        <g id="sr04-sensor-unit">
          ...
          <circle cx="8.98" cy="10" r="3.59" fill="url(#sr04-grad1)" />
          <circle cx="8.99" cy="10" r=".277" fill="#777" fillOpacity=".818" />
          <circle cx="8.98" cy="10" r="5.53" fill="url(#sr04-checkerboard)" opacity=".397" />
        </g>
      </defs>
      <path
      ...
      <path
        ...
        strokeWidth=".858"
      />
      <use xlinkHref="#sr04-sensor-unit" />
      <use xlinkHref="#sr04-sensor-unit" x="27.12" />
