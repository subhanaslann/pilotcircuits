    ...
    <g fontFamily="monospace">
      <defs>
        ...
        <g id={`${uid}-sr04-sensor-unit`}>
          ...
          <circle cx="8.98" cy="10" r="3.59" fill={`url(#${uid}-sr04-grad1)`} />
          <circle cx="8.99" cy="10" r=".277" fill="#777" fillOpacity=".818" />
          <circle
            cx="8.98"
            cy="10"
            r="5.53"
            fill={`url(#${uid}-sr04-checkerboard)`}
            opacity=".397"
          />
        </g>
      </defs>
      ...
      <path
        ...
        strokeWidth=".858"
      />
      <use xlinkHref={`#${uid}-sr04-sensor-unit`} />
      <use xlinkHref={`#${uid}-sr04-sensor-unit`} x="27.12" />
